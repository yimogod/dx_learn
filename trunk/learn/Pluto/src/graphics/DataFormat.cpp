...
std::string const DataFormat::_msName[DF_NUM_FORMATS] ={
    "UNKNOWN",
...
int const DataFormat::_msNumBytesPerStruct[DF_NUM_FORMATS] = {
    0,  // DF_UNKNOWN
...
int const DataFormat::_msNumChannels[DF_NUM_FORMATS] = {
    0,  // DF_UNKNOWN
...
bool const DataFormat::_msConvertChannel[DF_NUM_FORMATS] = {
    false,  // DF_UNKNOWN
